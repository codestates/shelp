                        ...
                        <ScrollBox >{/*useRef={boxRef}*/}
                            ...
                            {/* props: expDate, name, quant, storage, desc */}
                                <li>
                                    ...
                                    <input className='editButton' type='button' value='수정' onClick={modalcontroller}/>
                                </li>
                            </ul>
                        </ScrollBox>
                    ...
                    <Recipes> {/* right: 레시피 칸 */}
                        <ul>
                            <li>
                                ...
                                <a href='https://www.dispatch.co.kr/2034029'>delicious kimchichigae recipe</a>
                            </li>
                        </ul>
                    </Recipes>
                </Content>
                ...
                <Modal className='modalPage hide'>
                    <Options>
                        ...
                        <div className='options'>
                            <input className='option1' type='radio' name='storage' value='상온'/>
                            <input className='option2' type='radio' name='storage' value='냉장'/>
                            <input className='option3' type='radio' name='storage' value='냉동'/>
                        </div>
                    </Options>
                    <decisionbutton>
                        <input className='cancelButton' type='button' value='cancel' onClick={modalcontroller}/>
                        <input className='doneButton' type='button' value='done' onClick={modalcontroller}/>
                        <input className='deleteButton' type='button' value='delete' onClick={modalcontroller}/>
                    </decisionbutton>
                </Modal>
                :<div></div>
            }
